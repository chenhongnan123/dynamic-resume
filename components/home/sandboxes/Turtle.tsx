...
function Sphere({ position, scale = 1, speed = 0.1, color = 'white' }: {
  ...
  scale?: string | number | number[],
  speed?: string | number | number[],
...
function Turtle(props: {
  ...
  const { scene, animations } = useGLTF('/three/model/model_52a_-_kemps_ridley_sea_turtle_no_id-transformed.glb')
